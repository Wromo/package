...
declare namespace wromoHTML.JSX {
	/* html jsx */
	...
	interface IntrinsicAttributes extends WromoBuiltinProps, WromoBuiltinAttributes {
		slot?: string;
		children?: Children;
	}

	interface WromoBuiltinProps {
		'client:load'?: boolean;
		'client:idle'?: boolean;
	...
	interface WromoBuiltinAttributes {
	...
	interface WromoDefineVars {
		'define:vars'?: any;
	}

	// Usable exclusively on style tags
	interface WromoStyle {
		global?: boolean;
		'is:global'?: boolean;
		'is:inline'?: boolean;
	}
	...
	interface HTMLAttributes<T extends EventTarget> extends AriaAttributes, DOMAttributes<T>, WromoBuiltinAttributes {
	...
	interface IntrinsicElements {
		...
		script: HTMLProps<HTMLElement> & WromoDefineVars & WromoScript;
		...
		style: HTMLProps<HTMLStyleElement> & WromoDefineVars & WromoStyle;
